...
import numbers
#Restfomer代替RDB，引入scan 4+bipam+4(scam)
...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.deep_feature1 = RDG(G0=64, C=4, G=24, n_RDB=4) #输入64，输出64
        self.pam1 = PAM(64)
        ...
        self.RST1 = RDB(G0=64, C=4, G=32)
        self.scam1=SCAM(64)
        self.RST2 = RDB(G0=64, C=4, G=32)
        self.scam2=SCAM(64)
        self.RST3 = RDB(G0=64, C=4, G=32)
        self.scam3 = SCAM(64)
        self.RST4 = RDB(G0=64, C=4, G=32)
        self.scam4 = SCAM(64)
...
##########################################################################
## Gated-Dconv Feed-Forward Network (GDFN)   TransformerBlock调用
class FeedForward(nn.Module):
    ...
    def forward(self, x):
        ...
        return x
##########################################################################
## Multi-DConv Head Transposed Self-Attention (MDTA)  TransformerBlock调用
...
class SCAM(nn.Module):
    '''
    Stereo Cross Attention Module (SCAM) design by ZDY
    '''
