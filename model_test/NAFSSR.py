...
if __name__ == '__main__':
    ...
    data = torch.randn((1, 6, 128, 128))
    out = net(data)
    print(out.shape)
    #from thop import profile
    #flops, params = profile(net, inputs = (torch.ones(1, 6, 50, 50),))
    #print('FLOPs: %.1fGFlops' % (flops / 1e9))
    #print('Parameters:', params)


    t1 = torch.Tensor(1,6,162,138)
    t1 = t1.cuda()
    t2 = torch.Tensor(1,6,185,124)
    t2 = t2.cuda()
    t3 = torch.Tensor(1,6,176,120)
    t3 = t3.cuda()
    t4 = torch.Tensor(1,6,183,121)
    t4 = t4.cuda()
    t5 = torch.Tensor(1,6,178,125)
    t5 = t5.cuda()
    net = net.cuda()
    import time 
